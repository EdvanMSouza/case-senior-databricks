...
caminho = f"/Volumes/{CATALOG}/{SCHEMA}/{VOLUME}/estornos.csv"
...
df_metadata.write \
    ...
    .saveAsTable(f"{CATALOG}.{SCHEMA}.bronze_estornos")

print("Tabela bronze_estornos criada com sucesso!")

# COMMAND ----------

df_verifica = spark.table(f"{CATALOG}.{SCHEMA}.bronze_estornos")
print(f"Total na bronze_estornos: {df_verifica.count()}")
