...
caminho = f"/Volumes/{CATALOG}/{SCHEMA}/{VOLUME}/transacoes.csv"
...
df_metadata.write \
    ...
    .saveAsTable(f"{CATALOG}.{SCHEMA}.bronze_transacoes")

print("Tabela bronze_transacoes criada com sucesso!")

# COMMAND ----------

df_verifica = spark.table(f"{CATALOG}.{SCHEMA}.bronze_transacoes")
print(f"Total na bronze_transacoes: {df_verifica.count()}")
