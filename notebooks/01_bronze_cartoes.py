...
caminho = f"/Volumes/{CATALOG}/{SCHEMA}/{VOLUME}/cartoes_cdc.csv"
...
df_metadata.write \
    ...
    .saveAsTable(f"{CATALOG}.{SCHEMA}.bronze_cartoes")

print("Tabela bronze_cartoes criada com sucesso!")

# COMMAND ----------

df_verifica = spark.table(f"{CATALOG}.{SCHEMA}.bronze_cartoes")
print(f"Total na bronze_cartoes: {df_verifica.count()}")
