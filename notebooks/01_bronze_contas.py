...
caminho = f"/Volumes/{CATALOG}/{SCHEMA}/{VOLUME}/contas_cdc.csv"
...
df_metadata.write \
    ...
    .saveAsTable(f"{CATALOG}.{SCHEMA}.bronze_contas")

print("Tabela bronze_contas criada com sucesso!")

# COMMAND ----------

df_verifica = spark.table(f"{CATALOG}.{SCHEMA}.bronze_contas")
print(f"Total na bronze_contas: {df_verifica.count()}")
